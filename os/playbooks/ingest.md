...
6. Append the receipt (`YYYY-MM-DD ingest: <summary>` to os/worklog.md), then regenerate MAP.md and STATUS.md if any homes changed — regeneration last, so STATUS already includes this receipt.
