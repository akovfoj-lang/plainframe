...
under "router". Keep meaning to write that down somewhere findable.
...
and the idea becomes a seed file in incubator/. Then the receipt goes in os/worklog.md,
and only then does this file get deleted. Route, receipt, delete — in that order.
